...
[^1]: This notebook was created using R version 4.2.1 [@base] with the following R packages: ggforce v. 0.4.1 [@ggforce], knitr v. 1.43 [@knitr2014; @knitr2015; @knitr2023], rmarkdown v. 2.22 [@rmarkdown2018; @rmarkdown2020; @rmarkdown2023], stylo v. 0.7.5 [@stylo], stylo2gg v. 1.0.1 [@stylo2gg], tidyverse v. 2.0.0 [@tidyverse].
